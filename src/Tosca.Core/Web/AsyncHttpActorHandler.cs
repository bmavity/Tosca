...
namespace Tosca.Core.Web
{
	...
	public class AsyncHttpActorHandler :
		IHttpAsyncHandler
	{
		private readonly Func<AsyncHttpActor> _builder;

		public AsyncHttpActorHandler(Func<AsyncHttpActor> builder)
		{
			_builder = builder;
		}
		...
		{
			AsyncHttpActor actor = _builder();

			return actor.BeginAction(context, cb, data);
		}
